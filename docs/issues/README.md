...
| [ISS-8](ISS-8-kb-create-no-server-validation.md)  | Medium   | KB create endpoint accepts empty/missing required fields without error         | —         |
| [ISS-9](ISS-9-kb-upload-endpoint-undocumented.md) | Major    | KB file upload endpoint absent from API reference, underscore path in notebook | ~15 min   |
| [ISS-10](ISS-10-kb-resources-missing-path-500.md) | Medium   | Omitting `resource_path` on KB resources endpoint causes 500                   | —         |
